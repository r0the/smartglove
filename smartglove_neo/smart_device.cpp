...
void SmartDevice::setup() {
    ...
    configureSensor(SENSOR_FLEX_INDEX_FINGER, -100.0, 30.0, 2.0);
    configureSensor(SENSOR_FLEX_MIDDLE_FINGER, -100.0, 30.0, 2.0);
    configureSensor(SENSOR_FLEX_RING_FINGER, -100.0, 30.0, 2.0);
    configureSensor(SENSOR_FLEX_LITTLE_FINGER, -10.0, 30.0, 2.0);
