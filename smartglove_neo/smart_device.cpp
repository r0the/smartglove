...
void SmartDevice::setup() {
    ...
    configureSensor(SENSOR_DISTANCE, 0, 2000, 2.0);
    ...
    configureSensor(SENSOR_FLEX_INDEX_FINGER, 30.0, -100.0, 2.0);
    configureSensor(SENSOR_FLEX_MIDDLE_FINGER, 30.0, -100.0, 2.0);
    configureSensor(SENSOR_FLEX_RING_FINGER, 30.0, -100.0, 2.0);
    configureSensor(SENSOR_FLEX_LITTLE_FINGER, 30.0, -100.0, 2.0);
